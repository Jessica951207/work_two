!function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.Picker2 = t() : e.Picker2 = t()
}(this, function () {
    return function (e) {
        function t(n) {
            ...
            return s(t, e), a(t, [{
                ...
                key: "_bindEvent", value: function () {
                    ...
                    (0, f.addEvent)(this.pickerEl, "touchmove", function (e) {
                        ...
                        e.trigger("picker2.select", e.selectedVal, e.selectedIndex), t && e.trigger("picker2.valuechange", e.selectedVal, e.selectedIndex)
                    }), (0, f.addEvent)(this.cancelEl, "click", function () {
                        e.hide(), e.trigger("picker2.cancel")
                    })
                }
            }, {
                key: "_createWheel", value: function (e, t) {
                    ...
                    return this.wheels[t] = new h.default(e[t], {
                        ...
                        i.wheels[e].on("scrollEnd", function () {
                            ...
                            i.selectedIndex[t] !== n && (i.selectedIndex[t] = n, i.trigger("picker2.change", e, n))
                        })
                    }(t), this.wheels[t]
                }
            }, {
        ...
        e.exports = (n.default || n).template(function (e, t, i, n, r) {
            ...
            return h += '<div class="picker2">\n  <div class="picker2-mask mask-hook"></div>\n  <div class="picker2-panel panel-hook">\n    <div class="picker2-choose choose-hook">\n      <span class="cancel cancel-hook">取消</span>\n      <span class="confirm confirm-hook">确定</span>\n      <h1 class="picker2-title">', (l = i.title) ? a = l.call(t, {
                hash: {},
                data: r
            }) : (l = t && t.title, a = typeof l === c ? l.call(t, {
                hash: {},
                data: r
            }) : l), h += p(a) + '</h1>\n    </div>\n    <div class="picker2-content">\n      <div class="mask-top border-1px"></div>\n      <div class="mask-bottom border-1px"></div>\n      <div class="wheel-wrapper wheel-wrapper-hook">\n        ', a = i.each.call(t, t && t.data, {
                hash: {},
                inverse: u.noop,
                fn: u.program(1, o, r),
                data: r
            }), (a || 0 === a) && (h += a), h += '\n      </div>\n    </div>\n    <div class="picker2-footer footer-hook"></div>\n  </div>\n</div>'
        })
    }, function (e, t, i) {
        e.exports = i(8)
    }, function (e, t, i) {
        ...
        t = e.exports = i(17)(), t.push([e.id, '.picker2{display:none;position:fixed;top:0;z-index:100;width:100%;height:100%;overflow:hidden;text-align:center;font-family:PingFang SC,STHeitiSC-Light,Helvetica-Light,arial,sans-serif;font-size:14px;-moz-user-select:none;-webkit-user-select:none;-ms-user-select:none;user-select:none}.picker2 .picker2-mask{position:absolute;z-index:500;width:100%;height:100%;transition:all .5s;-webkit-transition:all .5s;background:transparent;opacity:0}.picker2 .picker2-mask.show{background:rgba(0,0,0,.6);opacity:1}.picker2 .picker2-panel{position:absolute;z-index:600;bottom:0;width:100%;height:243px;background:#fff;transform:translateY(243px);-webkit-transform:translateY(243px);transition:all .5s;-webkit-transition:all .5s}.picker2 .picker2-panel.show{transform:translateY(0);-webkit-transform:translateY(0)}.picker2 .picker2-panel .picker2-choose{position:relative;height:50px;color:#878787;font-size:14px}.picker2 .picker2-panel .picker2-choose .picker2-title{line-height:50px;font-size:19px;text-align:center;color:#333}.picker2 .picker2-panel .picker2-choose .cancel,.picker2 .picker2-panel .picker2-choose .confirm{position:absolute;padding:10px;top:6px}.picker2 .picker2-panel .picker2-choose .confirm{right:10px;color:#fa8919}.picker2 .picker2-panel .picker2-choose .cancel{left:0}.picker2 .picker2-panel .picker2-content{position:relative}.picker2 .picker2-panel .picker2-content .mask-bottom,.picker2 .picker2-panel .picker2-content .mask-top{position:absolute;z-index:10;width:100%;height:68px;pointer-events:none;transform:translateZ(0);-webkit-transform:translateZ(0)}.picker2 .picker2-panel .picker2-content .mask-top{top:0;background:-webkit-gradient(linear,left bottom,left top,from(hsla(0,0%,100%,.4)),to(hsla(0,0%,100%,.8)));background:-o-linear-gradient(bottom,hsla(0,0%,100%,.4),hsla(0,0%,100%,.8))}.picker2 .picker2-panel .picker2-content .mask-top:after,.picker2 .picker2-panel .picker2-content .mask-top:before{display:block;position:absolute;border-top:1px solid #ccc;left:0;width:100%;content:" "}.picker2 .picker2-panel .picker2-content .mask-top:before{display:none;top:0}.picker2 .picker2-panel .picker2-content .mask-top:after{display:block;bottom:0}.picker2 .picker2-panel .picker2-content .mask-bottom{bottom:0;background:-webkit-gradient(linear,left top,left bottom,from(hsla(0,0%,100%,.4)),to(hsla(0,0%,100%,.8)));background:-o-linear-gradient(top,hsla(0,0%,100%,.4),hsla(0,0%,100%,.8))}.picker2 .picker2-panel .picker2-content .mask-bottom:after,.picker2 .picker2-panel .picker2-content .mask-bottom:before{display:block;position:absolute;border-top:1px solid #ccc;left:0;width:100%;content:" "}.picker2 .picker2-panel .picker2-content .mask-bottom:before{display:block;top:0}.picker2 .picker2-panel .picker2-content .mask-bottom:after{display:none;bottom:0}.picker2 .picker2-panel .wheel-wrapper{display:-ms-flexbox;display:-webkit-box;display:flex;padding:0 10px}.picker2 .picker2-panel .wheel-wrapper .wheel{-ms-flex:1 1 1e-9px;-webkit-box-flex:1;flex:1;flex-basis:1e-9px;width:1%;height:173px;overflow:hidden;font-size:21px}.picker2 .picker2-panel .wheel-wrapper .wheel .wheel-scroll{margin-top:68px;line-height:36px}.picker2 .picker2-panel .wheel-wrapper .wheel .wheel-scroll .wheel-item{height:36px;overflow:hidden;white-space:nowrap;color:#333}.picker2 .picker2-footer{height:20px}@media (-webkit-min-device-pixel-ratio:1.5),(min-device-pixel-ratio:1.5){.border-1px:after,.border-1px:before{-webkit-transform:scaleY(.7);-webkit-transform-origin:0 0;transform:scaleY(.7)}.border-1px:after{-webkit-transform-origin:left bottom}}@media (-webkit-min-device-pixel-ratio:2),(min-device-pixel-ratio:2){.border-1px:after,.border-1px:before{-webkit-transform:scaleY(.5);transform:scaleY(.5)}}', ""])
    }, function (e, t) {
        e.exports = function () {
            var e = [];
